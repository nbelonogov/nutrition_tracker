# Generated by Django 4.2.15 on 2024-08-20 09:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(choices=[('М', 'Мужской'), ('Ж', 'Женский')], max_length=10, null=True, verbose_name='Пол')),
                ('weight', models.DecimalField(decimal_places=1, max_digits=3, null=True, verbose_name='Вес')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Завтрак', 'Завтрак'), ('Обед', 'Обед'), ('Ужин', 'Ужин')], max_length=10, null=True)),
